...
<!-- Hero Section -->
<section class="hero-section py-4 py-md-5 mb-5 shadow-sm">
    <div class="container">
        <div class="row align-items-center g-4 g-lg-5">
            ...
            <div class="col-lg-6 text-center text-lg-start" data-aos="fade-right">
                ...
                <h1 class="hero-title text-dark mb-3 font-heading" style="font-weight: 800; line-height: 1.2;">
                    Your Health. <br>
                    <span style="color: var(--primary-green);">Our Priority. Always.</span>
                </h1>
                <p class="hero-subtitle text-muted mb-4 fs-5 mx-auto mx-lg-0" style="max-width: 530px; line-height: 1.6; font-size: 1.05rem !important;">
    ...
    <div class="stats-section p-4 bg-white shadow-lg" data-aos="fade-up" data-aos-offset="0">
        <div class="row text-center g-4 justify-content-center">
            <?php if (empty($stats_counters)): ?>
                <div class="col-6 col-md-6 col-lg-3 stat-item">
                    <div class="px-2">
            ...
            <?php else: ?>
                <?php 
                $col_class = 'col-6 col-md-6 col-lg-3';
                $cnt = count($stats_counters);
                if ($cnt === 1) $col_class = 'col-12';
                elseif ($cnt === 2) $col_class = 'col-6';
                elseif ($cnt === 3) $col_class = 'col-4 col-md-4 col-lg-4';
                ?>
                <?php foreach ($stats_counters as $stat): ?>
                    <div class="<?php echo $col_class; ?> stat-item">
                        <div class="px-2">
...
<!-- Features Section -->
<section class="py-4 py-md-5 bg-transparent">
...
<section class="py-4 py-md-5 bg-light border-top border-bottom">
    <div class="container py-4">
        <div class="row align-items-center g-4 g-lg-5">
                ...
                <div class="row g-3 justify-content-center justify-content-lg-start">
                    <div class="col-6 col-sm-6 text-start">
                        <div class="d-flex align-items-center gap-2">
                            <span class="fs-5 text-success"><i class="fa-solid fa-circle-check"></i></span>
                            <span class="fw-bold text-dark small">AES-256 Encryption</span>
                        </div>
                    </div>
                    <div class="col-6 col-sm-6 text-start">
                        <div class="d-flex align-items-center gap-2">
                            <span class="fs-5 text-success"><i class="fa-solid fa-circle-check"></i></span>
                            <span class="fw-bold text-dark small">GDPR & HIPAA</span>
                        </div>
                    </div>
                    <div class="col-6 col-sm-6 text-start">
                        <div class="d-flex align-items-center gap-2">
                            <span class="fs-5 text-success"><i class="fa-solid fa-circle-check"></i></span>
                            <span class="fw-bold text-dark small">Secure QR Matrix</span>
                        </div>
                    </div>
                    <div class="col-6 col-sm-6 text-start">
                        <div class="d-flex align-items-center gap-2">
                            <span class="fs-5 text-success"><i class="fa-solid fa-circle-check"></i></span>
                            <span class="fw-bold text-dark small">24/7 Scan Audit</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 text-center" data-aos="fade-left">
                <div class="p-4 p-md-5 bg-white rounded-4 shadow-lg border border-light-subtle position-relative overflow-hidden" style="max-width: 460px; margin: 0 auto;">
    ...
    <div class="container py-3">
        ...
        <div class="row g-4">
            <div class="col-12 col-md-6 col-lg" data-aos="fade-up" data-aos-delay="100">
                <div class="p-4 text-center bg-light rounded-4 h-100 border border-light-subtle shadow-sm mb-3 mb-lg-0">
...
<section class="py-4 py-md-5 bg-light">
    <div class="container text-center py-4" data-aos="zoom-in">
        ...
        <a href="<?php echo BASE_URL; ?>contact.php" class="btn btn-success btn-lg rounded-pill px-5 py-3 w-100 w-sm-auto">
