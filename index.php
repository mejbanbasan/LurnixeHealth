...
<!-- ========================================================================= -->
<!-- DESKTOP VIEWPORT (Visible on Large Screens) -->
<!-- ========================================================================= -->
...
<!-- ========================================================================= -->
<!-- MOBILE APP VIEWPORT (Visible on Mobile/Tablet Screens) -->
<!-- ========================================================================= -->
<div class="d-block d-lg-none mobile-app-container p-3">
    <!-- Mobile Search Banner -->
    <div class="mobile-search-banner" data-aos="fade-down">
        <h2 class="mobile-search-banner-title">Find the Right Doctor</h2>
        <p class="mobile-search-banner-subtitle">Search registered doctor profiles and book appointments instantly</p>
        <form action="services.php" method="GET">
            <div class="mobile-search-row">
                <div class="mobile-search-input-group">
                    <i class="fa-solid fa-magnifying-glass"></i>
                    <input type="text" name="search" class="mobile-search-input" placeholder="Search doctors, specialities...">
                </div>
                <button type="submit" class="mobile-search-filter-btn">
    ...
    <!-- Category Swipe Scrollbar -->
    <div class="mb-4" data-aos="fade-up">
        <div class="mobile-doctors-section-header">
            <h3 class="mobile-doctors-title">Specializations</h3>
            <a href="services.php" class="mobile-doctors-viewall">View All</a>
        </div>
        <div class="mobile-category-scroll">
            <a href="services.php?category=all" class="mobile-category-item active">
                <div class="mobile-category-icon-box">
                    <i class="fa-solid fa-grip-all"></i>
                </div>
                <span class="mobile-category-label">All</span>
            </a>
            <a href="services.php?category=General Physician" class="mobile-category-item">
                <div class="mobile-category-icon-box">
                    <i class="fa-solid fa-user-doctor"></i>
                </div>
                <span class="mobile-category-label">Physician</span>
            </a>
            <a href="services.php?category=Pediatrics" class="mobile-category-item">
                <div class="mobile-category-icon-box">
                    <i class="fa-solid fa-baby"></i>
                </div>
                <span class="mobile-category-label">Pediatrics</span>
            </a>
            <a href="services.php?category=Gynecologist" class="mobile-category-item">
                <div class="mobile-category-icon-box">
                    <i class="fa-solid fa-person-pregnant"></i>
                </div>
                <span class="mobile-category-label">Gynecology</span>
            </a>
            <a href="services.php?category=Dermatologist" class="mobile-category-item">
                <div class="mobile-category-icon-box">
                    <i class="fa-solid fa-hand-holding-medical"></i>
                </div>
                <span class="mobile-category-label">Dermatology</span>
            </a>
            <a href="services.php" class="mobile-category-item">
                <div class="mobile-category-icon-box">
                    <i class="fa-solid fa-ellipsis"></i>
                </div>
                <span class="mobile-category-label">More</span>
            </a>
        </div>
    </div>
    ...
    <div class="mb-4" data-aos="fade-up">
        <div class="mobile-doctors-section-header">
            <h3 class="mobile-doctors-title">Upcoming Consultations</h3>
        </div>
        <div class="card border-0 rounded-4 shadow-sm p-3 mb-2" style="background: #ffffff;">
            <div class="d-flex align-items-center gap-3">
                <div class="bg-primary-subtle text-primary rounded-3 d-flex align-items-center justify-content-center" style="width: 48px; height: 48px; font-size: 1.3rem;">
                    <i class="fa-solid fa-calendar-check text-primary"></i>
                </div>
                <div class="flex-grow-1">
                    <div class="d-flex justify-content-between align-items-center">
                        <span class="badge bg-success-subtle text-success rounded-pill fw-bold" style="font-size: 0.65rem;">CONFIRMED</span>
                        <span class="text-muted" style="font-size: 0.7rem;">June 22, 10:30 AM</span>
                    </div>
                    <h6 class="mb-0 fw-bold text-dark mt-1" style="font-size: 0.9rem;">Dr. Sarah Jenkins</h6>
                    <span class="text-muted small" style="font-size: 0.75rem;">Cardiology Consultation</span>
                </div>
            </div>
            <hr class="my-2 opacity-25">
            <div class="d-flex justify-content-end gap-2">
                <a href="contact.php" class="btn btn-light btn-sm rounded-pill px-3 py-1 font-heading" style="font-size: 0.72rem; font-weight: 600;">Reschedule</a>
                <a href="contact.php" class="btn btn-outline-primary btn-sm rounded-pill px-3 py-1 font-heading" style="font-size: 0.72rem; font-weight: 600;">View Details</a>
            </div>
        </div>
    </div>
    ...
    <div class="mb-4" data-aos="fade-up">
        <div class="mobile-doctors-section-header">
            <h3 class="mobile-doctors-title">Top Doctors</h3>
            <a href="services.php" class="mobile-doctors-viewall">View All</a>
        </div>
        
        <!-- Doctor Card 1 -->
        <div class="mobile-doctor-card">
            <span class="mobile-doctor-availability availability-today">Available Today</span>
            <img src="https://images.unsplash.com/photo-1559839734-2b71ea197ec2?auto=format&fit=crop&q=80&w=300&h=360" alt="Dr. Sarah Jenkins" class="mobile-doctor-photo">
            <div class="mobile-doctor-info">
                <h5 class="mobile-doctor-name">
                    Dr. Sarah Jenkins 
                    <i class="fa-solid fa-circle-check text-primary" style="font-size: 0.85rem;" title="Verified Profile"></i>
                </h5>
                <span class="mobile-doctor-specialization">Cardiologist</span>
                <span class="mobile-doctor-degree">MD, FACC</span>
                <div class="mobile-doctor-rating">
                    <i class="fa-solid fa-star"></i> 4.9 <span>(120 reviews)</span>
                </div>
                <div class="mobile-doctor-location">
                    <i class="fa-solid fa-location-dot"></i> Heart & Vascular Center
                </div>
            </div>
            <a href="contact.php?doctor=sarah-jenkins" class="mobile-doctor-book-btn">Book</a>
        </div>

        <!-- Doctor Card 2 -->
        <div class="mobile-doctor-card">
            <span class="mobile-doctor-availability availability-tomorrow">Tomorrow</span>
            <img src="https://images.unsplash.com/photo-1622253692010-333f2da6031d?auto=format&fit=crop&q=80&w=300&h=360" alt="Dr. Marcus Vance" class="mobile-doctor-photo">
            <div class="mobile-doctor-info">
                <h5 class="mobile-doctor-name">
                    Dr. Marcus Vance 
                    <i class="fa-solid fa-circle-check text-primary" style="font-size: 0.85rem;" title="Verified Profile"></i>
                </h5>
                <span class="mobile-doctor-specialization">Pediatrician</span>
                <span class="mobile-doctor-degree">MD, FAAP</span>
                <div class="mobile-doctor-rating">
                    <i class="fa-solid fa-star"></i> 4.8 <span>(85 reviews)</span>
                </div>
                <div class="mobile-doctor-location">
                    <i class="fa-solid fa-location-dot"></i> Kids Care Clinic
                </div>
            </div>
            <a href="contact.php?doctor=marcus-vance" class="mobile-doctor-book-btn">Book</a>
        </div>

        <!-- Doctor Card 3 -->
        <div class="mobile-doctor-card">
            <span class="mobile-doctor-availability availability-today">Available Today</span>
            <img src="https://images.unsplash.com/photo-1594824813573-246434de83fb?auto=format&fit=crop&q=80&w=300&h=360" alt="Dr. Elena Rostova" class="mobile-doctor-photo">
            <div class="mobile-doctor-info">
                <h5 class="mobile-doctor-name">
                    Dr. Elena Rostova 
                    <i class="fa-solid fa-circle-check text-primary" style="font-size: 0.85rem;" title="Verified Profile"></i>
                </h5>
                <span class="mobile-doctor-specialization">Gynecologist</span>
                <span class="mobile-doctor-degree">MD, OB/GYN</span>
                <div class="mobile-doctor-rating">
                    <i class="fa-solid fa-star"></i> 5.0 <span>(142 reviews)</span>
                </div>
                <div class="mobile-doctor-location">
                    <i class="fa-solid fa-location-dot"></i> Women's Health Pavilion
                </div>
            </div>
            <a href="contact.php?doctor=elena-rostova" class="mobile-doctor-book-btn">Book</a>
        </div>
    </div>
</div>
