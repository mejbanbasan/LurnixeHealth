                    ...
                    return `
                        <div class="dropdown d-inline-block">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow border-0 small">
                                ...
                                <li><a class="dropdown-item py-2" href="generate-card.php?id=${row.member_id}&t=${Date.now()}" target="_blank"><i class="fa-solid fa-id-card text-success me-2"></i> View Card</a></li>
