...
<div class="sidebar bg-dark text-white border-end" id="sidebar-wrapper">
    <div class="sidebar-brand-box py-4 px-3 d-flex align-items-center">
        <img src="<?php echo BASE_URL; ?>assets/images/logo.png" alt="LurnixeHealth" style="width: 180px; max-width: 100%; height: auto; object-fit: contain; background: transparent;">
    </div>
