...
?>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="footer-brand d-flex align-items-center mb-3">
                        <?php if (!empty($logo_path) && file_exists(__DIR__ . '/../' . $logo_path)): ?>
                            <img src="<?php echo BASE_URL . $logo_path; ?>" alt="<?php echo htmlspecialchars($site_name); ?>" style="max-height: 80px; width: auto; object-fit: contain;" class="me-2">
                        <?php else: ?>
    ...
    <div class="mobile-bottom-nav d-lg-none d-flex justify-content-around">
