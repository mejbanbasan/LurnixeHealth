            ...
            <?php else: ?>
                <a href="<?php echo BASE_URL; ?>index.php" class="text-decoration-none d-flex align-items-center gap-2" style="flex: 1; min-width: 0;">
                    <?php if (!empty($logo_path) && file_exists(__DIR__ . '/../' . $logo_path)): ?>
                        <img src="<?php echo BASE_URL . $logo_path; ?>" alt="<?php echo htmlspecialchars($site_name); ?>" style="height: 85px; width: auto; object-fit: contain; max-width: 100%; mix-blend-mode: multiply;" class="flex-shrink-0">
                    <?php else: ?>
    ...
    <div class="offcanvas offcanvas-start d-lg-none" tabindex="-1" id="mobileMenu" aria-labelledby="mobileMenuLabel" style="width: 280px; z-index: 1050;">
        <div class="offcanvas-header border-bottom">
            <h5 class="offcanvas-title fw-bold font-heading text-primary d-flex align-items-center" id="mobileMenuLabel">
                <?php if (!empty($logo_path) && file_exists(__DIR__ . '/../' . $logo_path)): ?>
                    <img src="<?php echo BASE_URL . $logo_path; ?>" alt="<?php echo htmlspecialchars($site_name); ?>" style="max-height: 35px; mix-blend-mode: multiply;">
                <?php else: ?>
    ...
    <nav class="navbar navbar-expand-lg sticky-top navbar-light bg-white shadow-sm d-none d-lg-flex">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="<?php echo BASE_URL; ?>index.php">
                ...
                <?php if (!empty($logo_path) && file_exists(__DIR__ . '/../' . $logo_path)): ?>
                    <img src="<?php echo BASE_URL . $logo_path; ?>" alt="<?php echo htmlspecialchars($site_name); ?>" style="max-height: 100px; width: auto; object-fit: contain; mix-blend-mode: multiply;">
                <?php else: ?>
